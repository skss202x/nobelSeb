...
const data = [
    ...
    { name: "Dale T. Mortensen", image: "./images/dale_mortensen.jpg", year: "2010", hook: "Mortensen = jobs are constantly being created and destroyed.", reason: "They explained how job markets work when employers and workers must find each other rather than matching instantly. Their research focused on why jobs can remain unfilled and people unemployed even when there are openings — because finding the right worker or job takes time and effort (this is known as search and matching theory). This helps economists understand unemployment, job vacancies, and the effects of policies like unemployment benefits." },
    ...
    { name: "Christopher A. Sims", image: "./images/christopher_sims.jpg", year: "2011", hook: "SIMS = simulations of the economy.", reason: "They developed methods for using data to understand the effects of economic policy over time. Sargent studied how people’s expectations about inflation and government policy affect economic outcomes. Sims created statistical tools (like VAR models) to see how the economy reacts to shocks such as changes in interest rates. These tools help policymakers and researchers understand cause and effect in macroeconomics." },
    ...
    { name: "Lloyd S. Shapley", image: "./images/lloyd_shapley.jpg", year: "2012", hook: "Shapley shapes fair outcomes.", reason: "They solved important problems about matching people and resources in markets where prices alone can’t do the job well. For example, how to match students to schools, doctors to residency positions, or organ donors to recipients. Shapley developed the mathematics of stable matching, and Roth applied it to real‑world systems to improve fairness and efficiency." },
